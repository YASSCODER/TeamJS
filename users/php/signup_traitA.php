    ...
    if(isset($_POST['email']) && isset($_POST['user-name']) && isset($_POST['pass']) && isset($_POST['cpass']))
    {
         ...
         if($row == 0)
        {
                ...
                if($passwd == $cpasswd)
                {
                    ...
                    header('Location : ../html/AdminPage.html?reg_err=succes');
                }else header('Location : ../html/signUpAdmin.html?reg_err=Password');
        }else header('Location : ../html/signUpAdmin.html?reg_err=already');
    }
    ?>